...
import { Building2, ArrowLeft, ExternalLink, Star, Calendar, Users } from 'lucide-react';
...
const HotelResultsPage: React.FC = () => {
  ...
  const handleBooking = (hotelName: string, provider: string, bookUrl: string) => {
          ...
          {results.length === 0 ? (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <button
                  onClick={() => handleBooking(hotel.hotelName, hotel.provider, hotel.bookUrl)}
